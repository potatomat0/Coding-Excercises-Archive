  ...
  <table width="350" border="0" align="center" cellpadding="2" cellspacing="2" bgcolor="#DB95B8">
    ...
    <tr>
      ...
      <td>
        ...
        foreach(glob('./images/*.*') as $filename):?>
          ...
          <?php echo substr($filename,9,strlen($filename)-13); ?>
          </option>
         <?php  
        endforeach;
          ?>
    ...
    <tr>
      ...
      <td><label>
        ...
        value="<?php 
          if(isset($_POST['ten_hang'])) {echo $_POST['ten_hang'];}
        ?>"
        />
      </label></td>
    </tr>
    <tr>
      ...
      <td><input required name="sl" type="number" min="1" id="sl" size="15" 
      value="<?php 
          if(isset($_POST['sl'])) {echo $_POST['sl'];}
        ?>"
      /></td>
    </tr>
    <tr>
      ...
      <td width="233"><label>
        ...
        value="<?php 
          if(isset($_POST['dg'])) {echo $_POST['dg'];}
        ?>"
        />
      </label></td>
    </tr>
